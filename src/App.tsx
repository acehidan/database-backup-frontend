  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/v1/backup-config`,
        {
          method: "POST",
          headers: {
      ...
      setStatusMessage(
        "Failed to create backup configuration. Please try again."
      );
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Configure automated backups for your databases with ease
            </p>
          </div>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <span>Create Backup Configuration</span>
                    </>
                  )}
                </button>
              </div>
